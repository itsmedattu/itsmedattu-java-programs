...
public class perfect_sum {
  ...
  public static void main(String[] args) {
     ...
     * System.out.println("Please enter number of elements"); System.out.println();
     * int numElements=sc.nextInt();
     * System.out.println("Please enter array elements"); System.out.println();
     * for(int i=0;i<numElements;i++) { al.add(sc.nextInt()); }
     * System.out.println("Please enter the number"); System.out.println(); int
     * number=sc.nextInt();
     */
    int numElements = 6;
    int[] al = { 2, 3, 5, 6, 8, 10 };
