...
public class findLowestPossibleNumber2 {
  ...
  public static void main(String[] args) {
    ...
    // System.out.println("Lowest Possible number for str is "
    // +GenerateLowestNumber("4205123",4));
    // System.out.println("Lowest Possible number for str is "
    // +GenerateLowestNumber("216504",3));
    // System.out.println("Lowest Possible number for str is "
    // +GenerateLowestNumber("991",2));
    System.out.println("Lowest Possible number for str is " + GenerateLowestNumber("765028321", 5));
    // System.out.println("Lowest Possible number for str is "
    // +GenerateLowestNumber("1000454",5));
